    ...
    return (
        <div {...otherProps} className={cx("relative h-[120px] w-[152px]", className)}>
            <svg viewBox="0 0 152 120" fill="none" className={cx("size-full stroke-inherit text-inherit", svgClassName)}>
                <circle cx="76" cy="52" r="52" className="fill-slate-100" />

                <circle cx="21" cy="19" r="5" className="fill-slate-100" />
                <circle cx="18" cy="109" r="7" className="fill-slate-100" />
                <circle cx="145" cy="35" r="7" className="fill-slate-100" />
                <circle cx="134" cy="8" r="4" className="fill-slate-100" />
...
export const md = ({
    ...
    return (
        <div {...otherProps} className={cx("relative h-[137px] w-[182px]", className)}>
            <svg viewBox="0 0 182 137" fill="none" className={cx("size-full stroke-inherit text-inherit", svgClassName)}>
                <circle cx="91" cy="64" r="64" className="fill-slate-100" />

                <circle cx="25" cy="20" r="6" className="fill-slate-100" />
                <circle cx="22" cy="112" r="8" className="fill-slate-100" />
                <circle cx="165" cy="36" r="8" className="fill-slate-100" />
                <circle cx="154" cy="9" r="5" className="fill-slate-100" />
    ...
    return (
        <div {...otherProps} className={cx("relative h-[160px] w-[220px]", className)}>
            <svg viewBox="0 0 220 160" fill="none" className={cx("size-full stroke-inherit text-inherit", svgClassName)}>
                <circle cx="110" cy="80" r="80" className="fill-slate-100" />
                <circle cx="26" cy="20" r="8" className="fill-slate-100" />
                <circle cx="198" cy="126" r="6" className="fill-slate-100" />
                <circle cx="25" cy="138" r="10" className="fill-slate-100" />
                <circle cx="210" cy="46" r="10" className="fill-slate-100" />
                <circle cx="191" cy="11" r="7" className="fill-slate-100" />
