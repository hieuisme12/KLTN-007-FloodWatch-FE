...
const ModerationPage = () => {
  ...
  const fetchLocationDescription = async (lat, lng) => {
    ...
    try {
      ...
      // Ignore invalid cache in localStorage
    }
  ...
  useEffect(() => {
    ...
    // loadReports is stable enough for polling; listing it would reset the interval every render
      ...
      {loading ? (
        ...
        <div style={{ 
          ...
          {reports.map((report) => {
            ...
            const ModerationStatusIcon = moderationBadge.icon;
                ...
                <div style={{
                  ...
                  <div style={{
                    ...
                    <span style={{
                      ...
                      <ModerationStatusIcon /> {moderationBadge.text}
                    </span>
                  </div>
